...
st.set_page_config(page_title="Dashboard Khusus")

if "login_status" in st.session_state and st.session_state.login_status:
    if st.session_state.role != "khusus":
        st.warning("Kamu Tidak Memiliki Akses Ke Halaman Ini.")
    else:
        def show_home():
            with st.sidebar:
        ...
        # ⬅️ Jangan lupa panggil fungsinya
        show_home()
else:
    st.error("Silahkan Login terlebih dahulu dari halaman utama.")